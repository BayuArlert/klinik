        ...
        <AppLayout title="Tambah Pasien">
            ...
            <div className="max-w-3xl mx-auto">
                <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">Tambah Pasien Baru</h2>
                        <p className="text-sm text-gray-500 mt-1">Buat akun pasien baru di sistem klinik.</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <form onSubmit={submit} className="p-6 sm:p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700" htmlFor="password_confirmation">Konfirmasi Password <span className="text-red-500">*</span></label>
                                <input
