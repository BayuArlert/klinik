    ...
    return (
        <AppLayout title="Dashboard Pasien">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {/* Stats Card */}
                <div className="bg-white rounded-xl border border-rose-100 p-6 shadow-sm flex items-center gap-4">
                ...
                {/* Quick Action */}
                <div className="md:col-span-2 bg-gradient-to-r from-rose-500 to-rose-600 rounded-xl p-6 shadow-sm text-white flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div>
                        <h3 className="text-lg font-semibold">Butuh Pemeriksaan?</h3>
                        <p className="text-rose-100 text-sm mt-1">Daftar antrian sekarang untuk mendapatkan pelayanan medis.</p>
                    </div>
                    <Link 
                        href={pasien.pendaftaran.create.url()} 
                        className="bg-white text-rose-600 px-6 py-2 rounded-lg font-medium shadow-sm hover:bg-gray-50 transition-colors whitespace-nowrap"
                    >
                        Daftar Antrian
                    </Link>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-rose-600"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        Antrian Hari Ini
                    </h2>
                    
                    {antrianAktif ? (
                        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden text-center">
                            <div className="bg-rose-50 py-3 border-b border-rose-100">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-5xl font-black text-rose-600 my-4">{antrianAktif.nomor_antrian}</p>
                ...
                <div className="lg:col-span-2">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-rose-600"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                            Riwayat Pemeriksaan Terbaru
                        </h2>
                        <Link href={pasien.pendaftaran.index.url()} className="text-sm font-medium text-rose-600 hover:text-rose-700">Lihat Semua</Link>
                    </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="truncate">
                                                <div className="flex text-sm">
                                                    <p className="font-medium text-rose-600 truncate">{item.jadwal?.bidan?.name}</p>
